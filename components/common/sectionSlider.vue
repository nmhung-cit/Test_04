        ...
        <div class="section_slider__content">
            <template v-if="props.isShowSlider">
                <div class="section_slider__content--slider">
                    <swiper-container ref="swiperEl" :slidesPerView="props.slidesPerView"
                        :spaceBetween="props.spaceBetween">
                        <swiper-slide v-for="(item, idx) in props.itemContent" :key="idx"
                            :class="[{ 'slide-auto': slidesPerView === 'auto' }]">
                            <div class="item__slide">
                                <nuxt-link :to="item?.url"><img :src="item?.img ?? ''"
                                        :alt="item?.name ?? 'img-slide'" /></nuxt-link>
                            </div>
                        </swiper-slide>
                    </swiper-container>
                </div>
            ...
            <template v-else>
                <div class="section_slider__content--img">
                    <div class="item__slide" v-for="(item, idx) in props.itemContent" :key="idx">
                        <nuxt-link :to="item?.url"><img :src="item?.img ?? ''"
                                :alt="item?.name ?? 'img-slide'" /></nuxt-link>
                    </div>
                </div>
